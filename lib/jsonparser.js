...
phssr.makeHardCodedStyleTag = function(reporterOptions){
    ...
    styleTag+= ".traceinfo > div{width: 50%;position: relative;margin: 10% auto;padding: 5px 20px 13px 20px;background: #fff; overflow-wrap: break-word;}";
    ...
    styleTag+= ".textWrapper {overflow-wrap: break-word;}";
    styleTag+= ".img-col {min-width: 35px;}";
    styleTag+= "</style>";
...
phssr.makeHTMLPage = function(tableHtml, reporterOptions){
    ...
    staticHTMLContentprefix +=  " <ul><li><ul><li><h1>Test Results</h1><table class='header'>";
    staticHTMLContentprefix +=  "<tr><td class='desc-col'>Description</td><td class='status-col'>Passed</td>";
    staticHTMLContentprefix +=  "<td class='browser-col'>Browser</td>";
    staticHTMLContentprefix +=  "<td class='os-col'>OS</td><td class='msg-col'>Message</td>";
    staticHTMLContentprefix +=  "<td class='img-col'>Screenshot</td></tr></table></li></ul></li></ul>";
...
function generateHTML(data){
    ...
    var stackTraceInfo = data.passed? '': '<br/><a onclick="showTrace()" href="#trace-modal'+loopCount+'">View Stack Trace Info</a><br/> <div id="#trace-modal'+loopCount+'" class="traceinfo"><div class="textWrapper"><a href="#close" onclick="closeTraceModal()" title="Close" class="close">X</a>' + data.trace + '</div></div>';
...
function processJson(jsonData, options){
    ...
    function parseJSON(element) {
         var alternateColor = loopCount % 2 == 0 ? 'background-color: #D0CECE;': '';
        if(element.children){
            ...
            element.children.forEach(function (child, index, childArr) {
                if (child.children) {
                    ...
                    jsonStr += '<li><div style="background-color: #D0CECE; width: 95%;">'+element.desc+ '</div>' + ss +'</li>';
    ...
    tableHtml += "<ul><li><ul><li><div><h2><u>Results summary</u></h2>";
    tableHtml += "<b>Total tests passed</b>: "+ passCount +" <br/> <b>Total tests failed</b>: "+ failCount +" <br/> This report generated on "+new Date()+" </div></li></ul></li></ul>";
